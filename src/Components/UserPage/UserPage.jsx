            ...
            <MDBCard className="mb-4">
              <MDBCardBody>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">Comedy, Horror, Shorts</MDBCardText>
                  </MDBCol>
                </MDBRow>
              </MDBCardBody>
            </MDBCard>
            ...
            <MDBRow>
              <MDBCol md="6">
                <MDBCard className="mb-4 mb-md-0">
                  <MDBCardBody>
                    <MDBCardText className="mb-4"><span className="text-primary font-italic me-1">Post 1</span> Horror Film</MDBCardText>
                    <MDBCardText className="mb-1" style={{ fontSize: '.77rem' }}>This is the Post, will follow yalls implementation</MDBCardText>
              ...
              <MDBCol md="6">
                <MDBCard className="mb-4 mb-md-0">
                  <MDBCardBody>
                    <MDBCardText className="mb-4"><span className="text-primary font-italic me-1">Post 2</span> Comedy Short</MDBCardText>
                    <MDBCardText className="mb-1" style={{ fontSize: '.77rem' }}>Another Post</MDBCardText>
                    <MDBProgress className="rounded">
                      <MDBProgressBar width={80} valuemin={0} valuemax={100} />
                    </MDBProgress>
                  </MDBCardBody>
...
//             helloWorld();
//             {/* Your UserPage content goes here */}
//         </div>
//     );
// };
